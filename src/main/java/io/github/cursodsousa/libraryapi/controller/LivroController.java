...
public class LivroController implements GenericController {
    ...
    @GetMapping("/{id}")
    public ResponseEntity<ResultadoPequisaLivroDTO> obterDetalhes(
    ...
    @GetMapping
    public ResponseEntity<Page<ResultadoPequisaLivroDTO>> pesquisa(
        ...
        Page<ResultadoPequisaLivroDTO> resultado =  paginaResultado.map(mapper::toDTO);
